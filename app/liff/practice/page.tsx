    ...
    <div>
      <div className="mb-4">
        ...
        <div className="flex gap-2">
          <Link
            href={subjectId ? `/liff/practice?subject=${subjectId}` : "/liff/practice"}
          >
            <Badge
          ...
          <Link
            href={
              subjectId
                ? `/liff/practice?day=1&subject=${subjectId}`
                : "/liff/practice?day=1"
            }
          >
            <Badge
          ...
          <Link
            href={
              subjectId
                ? `/liff/practice?day=2&subject=${subjectId}`
                : "/liff/practice?day=2"
            }
          >
            <Badge
...
export default async function LiffPracticePage({
  searchParams,
}: {
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-5">
      <div className="mb-5">
        ...
        <h1 className="text-xl font-bold">ฝึกทำข้อสอบ PLE</h1>
