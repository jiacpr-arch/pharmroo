   ...
   <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_260px]">
    <article className="min-w-0">
     <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-9">
      <div className="prose prose-lg max-w-none prose-headings:text-slate-900 prose-h2:mt-10 prose-h2:rounded-2xl prose-h2:border prose-h2:border-emerald-100 prose-h2:bg-gradient-to-r prose-h2:from-emerald-50 prose-h2:to-white prose-h2:px-5 prose-h2:py-4 prose-h2:text-emerald-800 prose-h3:mt-7 prose-h3:text-rose-700 prose-p:leading-8 prose-a:text-emerald-700 prose-strong:text-slate-900 prose-ul:rounded-2xl prose-ul:border prose-ul:border-slate-100 prose-ul:bg-slate-50 prose-ul:px-8 prose-ul:py-5 prose-li:my-2 prose-blockquote:rounded-2xl prose-blockquote:border-rose-300 prose-blockquote:bg-rose-50 prose-blockquote:px-5 prose-blockquote:py-3" dangerouslySetInnerHTML={{__html:post.content}}/>
     </div>
